...
public class gbInsane {
   ...
   * @param manyMonsters
   */
  public gbInsane(int manyBoxes, int manyCoins, int manyMonsters) {
  ...
  private void boxesInitialization() {
    ...
    coinBronze bronze = new coinBronze(5);
    monsGodzilla godzilla = new monsGodzilla(-90, "MAX VERSTAPPENN");
    ...
    for (int i = 0; i < manyCoins; i++) {
      boardGame[mixCoin[i]].addCoin(bronze);
    }
